          ...
          child: Column(
            ...
            children: [
              ...
              if (isOwner) ...[
                if (!isCompleted)
                  Row(
                    children: [
                      ElevatedButton(
                        onPressed: () async {
                          await ParticipationProvider().finishReviewParticipation(participationId: participationId, appName: appName);
                ...
                if (isCompleted)
                  const Text('이미 승인 또는 신고된 리뷰입니다.', style: TextStyle(color: Colors.grey)),
              ] else ...[
                if (isCompleted)
                  const Text('이미 승인 또는 신고된 된 리뷰입니다.', style: TextStyle(color: Colors.grey)),
              ]
            ],
          ),
        ),
